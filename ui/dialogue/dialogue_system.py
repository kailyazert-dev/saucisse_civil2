...
class DialogueSystem:
    ...
    def _build_system_prompt(self, pnj_nom: str) -> str:
        if pnj_nom in IbmI_personnage.personnages:
            d = IbmI_personnage.personnages[pnj_nom]
            return (
        ...
        return "Tu es un personnage mystérieux. Reste vague et bref."
    ...
    def _call_api(self, message: str, pnj) -> str:
        ...
        nom           = pnj.nom
        system_prompt = self._build_system_prompt(nom)
