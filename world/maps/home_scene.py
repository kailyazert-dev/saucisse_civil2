...
class HomeScene(BaseScene):
    ...
    def setup(self, last_map):
        ...
        loader = MapLoader("HOME", arc_id=arc_id)
    ...
    def _sleep_objective(self):
        ...
        for quest in self.quest_manager.arc.quests:
            ...
            for obj in quest.objectives:
                if obj.type == "map_action" and obj.stat_key == "lit" and obj.status != "t":
                    return obj
        return None

    def _sleep_available(self) -> bool:
        return self._sleep_objective() is not None
    ...
    def on_update(self, delta_time):
        ...
        if self._fade_dir == 1:
            ...
            if self._fade_alpha >= 255:
                sleep_obj = self._sleep_objective()
                if sleep_obj:
                    self.quest_manager.complete_map_action_objective(sleep_obj.name)
