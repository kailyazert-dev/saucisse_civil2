...
├── loader/         — chargement des configs JSON de map
...
- Le **loader** lit les fichiers JSON dans `map/map_configs/` pour instancier PNJs et objets.

## Ajouter une nouvelle map

1. Créer un fichier JSON dans `map/map_configs/<NOM>.json`
